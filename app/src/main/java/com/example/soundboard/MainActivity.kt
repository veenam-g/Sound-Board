...
class MainActivity : AppCompatActivity() {
    ...
    private val soundControlsFragment = SoundControlsFragment()
        ...
        builder.setView(input)
            ...
            .setPositiveButton(R.string.save) { dialog, _ ->
                ...
                if (soundbankName.isNotBlank()) {
                    ...
                    // You can show an error message if the name is empty
                }
                dialog.dismiss()
            }
    ...
    private fun saveSoundbank(name: String) {
        val selectedSounds = viewModel.selectedSounds.value ?: return
        ...
        lifecycleScope.launch {
            ...
            Log.d("MainActivity", "Saved soundbank: $name")
        }
    }

    private suspend fun addInitialSoundbanks() {
        val initialSoundbanks = listOf(
            Soundbank("Sound Bank 1", "Cat Meow", "Dog Bark", "Cow Moo", "Elephant Trumpet", "Lion Roar"),
            Soundbank("Sound Bank 2", "Phone Ring", "Doorbell", "Alarm Clock", "Siren", " পাখির কিচিরমিচির"),
            Soundbank("Sound Bank 3", "Rain", "Thunder", "Wind", "Waves", "Fire Crackling")
        )
